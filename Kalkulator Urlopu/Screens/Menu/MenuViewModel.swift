...
class MenuViewModel: ObservableObject {
    ...
    var cards = [
        MenuCard(title: "Urlop macierzyński", subtitle: "Kalkulator oblicza pełny okres należnych urlopów z tytułu macierzyństwa, tj. urlopu macierzyńskiego / na warunkach urlopu macierzyńskiego oraz urlopu rodzicielskiego.", image: .maternityLeave, link: .maternityLeaveCalculator),
